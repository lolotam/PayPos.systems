...
>
> **Changelog**
> - **V3.2 (2026-09-23)** — §5: the outbox dispatcher is the second named exception to "every tenant access through `withTenant()`" (plan v4 T7b, ADR-0003 §3).
